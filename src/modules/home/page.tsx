  ...
  return (
    <div className="bg-[#0F1115] text-white min-h-screen font-sans selection:bg-primary/30">
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative pt-20 pb-32 md:pt-32 md:pb-48 px-6 overflow-hidden">
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            >
              Building Web & Mobile Products That{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C778DD] to-blue-400">
                Work.
              </span>
            </motion.h1>
            ...
            >
              ...
              building web and mobile applications with React, Next.js,
              TypeScript and React Native. I enjoy turning product requirements
              into clean, functional interfaces and reliable systems.{" "}
            </motion.p>
              ...
              {[
                {
                  ...
                  title: "React & Next.js",
                  desc: "Building responsive production interfaces with React, Next.js, TypeScript and Tailwind CSS.",
                },
                {
                  icon: <Layers className="text-blue-400" />,
                  title: "Web & Mobile",
                  desc: "Professional experience building both web applications and React Native mobile applications with Expo.",
                },
                {
                  icon: <Globe className="text-purple-400" />,
                  title: "APIs & Data",
                  desc: "Working with GraphQL, REST APIs, Apollo Client, Node.js and MongoDB.",
                },
                {
                  icon: <ShieldCheck className="text-green-400" />,
                  title: "Product Development",
                  desc: "Turning requirements and workflows into usable features, from interface development to application logic and integration.",
                },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
              <div className="max-w-xl">
                ...
                <p className="text-gray-400">
                  Selected projects that demonstrate end-to-end product thinking
                      ...
                      <div className="flex gap-4">
                        {project.live && (
                          <Link
                            href={project.live}
                            target="_blank"
                            className="px-4 py-2 bg-white/20 backdrop-blur-md rounded-lg text-sm font-bold border border-white/30"
                          >
                            Live Demo
                          </Link>
                        )}
                  ...
                  <div className="p-8">
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.map((t, i) => (
                        <span
                          key={i}
                          className="px-2 py-1 text-[10px] uppercase tracking-wider font-bold bg-primary/10 text-primary border border-primary/20 rounded-md"
                        >
                          {t}
                        </span>
                      ))}
            ...
            >
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
                  <div>
                    <h3 className="text-2xl font-bold mb-1">AsyncTechs</h3>
                ...
                <ul className="space-y-3 text-gray-400">
                  <li className="flex items-start gap-3">
                    ...
                    />
                    <span>
                      Worked on web and mobile applications for clients across
                      e-commerce, influencer management and other business
                      workflows.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    />
                    <span>
                      Built interfaces using React, Next.js, TypeScript and
                      Tailwind CSS, with React Native/Expo for mobile
                      applications.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    />
                    <span>
                      Integrated frontend applications with GraphQL and REST
                      APIs using Apollo Client and other API tooling.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2
                    ...
                    />
                    <span>
                      Worked across new features, existing codebases, bug fixes
                      and changing client requirements in a small development
                      team.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    />
                    <span>
                      Reused and extended shared components and application
                      patterns across projects to speed up development and
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row gap-16 items-center">
              <div className="flex-1">
                <h2 className="text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">
                  Modern Solutions for Fast-Growing Startups
                </h2>
                <p className="text-gray-400 text-lg mb-12">
                  I specialize in building complex, data-driven applications
                  that provide real value to users and founders.
                </p>
        ...
        <section className="py-32 px-6 border-t border-white/5">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400">
                Technologies I use to build web, mobile and backend
                systems.{" "}
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
                ...
                <div className="flex flex-wrap gap-3">
                  {TECH_STACK.frontend.map((t, i) => (
                    <span
                      key={i}
                      className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-sm font-medium"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
                ...
                <div className="flex flex-wrap gap-3">
                  {TECH_STACK.backendAndApi.map((t, i) => (
                    <span
                      key={i}
                      className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-sm font-medium"
                    >
              ...
              <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
                ...
                <div className="flex flex-wrap gap-3">
                  {TECH_STACK.databaseAndTools.map((t, i) => (
                    <span
                      key={i}
                      className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-sm font-medium"
                    >
        ...
        <section id="about" className="py-32 px-6">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-gray-400 leading-relaxed mb-12">
              I&apos;m Uthman Abdulganiyu, a software engineer based in
              Lagos, Nigeria. I&apos;ve spent the last 4+ years building web and
              mobile applications, working mainly with React, Next.js,
              TypeScript and React Native. My professional experience has
              involved turning client requirements into working features,
              integrating APIs, maintaining existing applications and working
              across different products and codebases. Outside of professional
              work, I build my own products to explore ideas that interest me.
              Some of those include MaternAlert, a maternal-health platform, and
              VideoAI, an automated AI-powered video production system. I enjoy
              understanding how a product is supposed to work, figuring out the
              technical pieces behind it and turning that into something people
              can actually use.
            </p>
            ...
            <div className="p-12 md:p-20 rounded-[3rem] bg-primary relative overflow-hidden text-center">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-white/80 max-w-2xl mx-auto mb-12 leading-relaxed">
                  I&apos;re currently open to software engineering opportunities in Lagos and remote roles.
                </p>
      ...
      <footer className="py-12 px-6 border-t border-white/5 text-center text-gray-500 text-sm">
        <p>
         © {new Date().getFullYear()} Uthman Abdulganiyu.
