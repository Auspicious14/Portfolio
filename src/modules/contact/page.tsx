  ...
  return (
    <div className="min-h-screen bg-[#0F1115] text-white">
      ...
      <div className="mx-auto px-6 py-32 container max-w-6xl">
        <h1 className="text-4xl md:text-6xl font-bold mb-8">Let&apos;s Build Together</h1>
        <p className="text-gray-400 text-lg mb-16 max-w-2xl">Ready to turn your vision into a working product? Reach out and let&apos;s discuss your MVP.</p>
        <ContactComponent />
      </div>
